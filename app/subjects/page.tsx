  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-6 py-12 md:px-8 md:py-16">
      <div className="flex flex-col items-center text-center gap-2 animate-fade-in-up">
        <h1 className="font-display text-6xl font-bold tracking-tight md:text-7xl text-white">All subjects</h1>
        <p className="text-lg text-white/60">Pick a subject to see every textbook available for it.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col min-w-0 flex-1">
                <h2 className="font-display text-xl font-bold text-white">{subject}</h2>
